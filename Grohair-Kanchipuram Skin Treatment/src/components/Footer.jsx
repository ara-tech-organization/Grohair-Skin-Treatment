      ...
      <div className="px-5 py-5 border-b border-white/10 flex flex-col gap-4">
        ...
        >
          ...
          <span className="text-[12px] text-white/45 leading-relaxed hover:text-red-400 active:text-red-400 transition-colors">
            1st Floor, KTS Towers, Old no.15B, New No.55, Nellukara St, above Federal Bank, Kanchipuram, Tamil Nadu 631502
          </span>
        </a>

        {/* Phone → Dialer */}
        <a href="tel:+919751056789" className="flex items-center gap-3 group">
          ...
          <span className="text-[12px] text-white/45 hover:text-red-400 active:text-red-400 transition-colors">097510 56789</span>
        </a>

        {/* Email → Mail app */}
        <a href="mailto:Kanchipuram@adgrohair.com" className="flex items-center gap-3 group">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="w-4 h-4 text-red-500 shrink-0">
