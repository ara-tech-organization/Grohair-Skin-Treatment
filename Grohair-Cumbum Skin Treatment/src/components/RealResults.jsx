// Import your before/after images here:
    ...
    <section className="px-4 py-7 bg-white">
      ...
      <div className="flex gap-2 mb-5">
        <div className="flex-1 relative rounded-xl overflow-hidden">
          {/* Replace with: <img src={beforeImg} alt="Before" className="w-full h-[160px] object-cover" /> */}
          <div className="w-full h-[160px] bg-gray-300" />
          <span className="absolute bottom-0 left-0 bg-black/60 text-white text-[10px] font-bold px-2 py-1 tracking-widest">
            BEFORE
          </span>
        </div>
        <div className="flex-1 relative rounded-xl overflow-hidden">
          {/* Replace with: <img src={afterImg} alt="After" className="w-full h-[160px] object-cover" /> */}
          <div className="w-full h-[160px] bg-gray-400" />
