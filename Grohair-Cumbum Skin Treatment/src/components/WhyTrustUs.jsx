...
import { BRANCH_NAME } from '../constants/siteDetails'
...
const trust = [
  {
    ...
    desc: 'Latest PRP, GFC & Laser equipment used by certified trichologists.',
  },
  {
    icon: '🛡️',
  ...
  },
  {
    ...
    desc: 'Every patient gets a custom treatment plan based on their hair analysis.',
  },
]
    ...
    <section className="bg-white">
      ...
      <div className="bg-gray-900 px-4 py-6">
        <h2 className="text-[20px] font-bold text-white text-center mb-5">
          Why Trust <span className="text-red-400">Grohair {BRANCH_NAME}?</span>
        </h2>
