...
const MAPS_URL = 'https://www.google.com/maps/search/?api=1&query=First+Floor,+LF+Rd,+Opp+Urban+Hospital,+Nethaji+Nagar,+Pathirakaliamman+Kovil,+Cumbum,+Tamil+Nadu+625516'
...
export default function Footer() {
  return (
    <footer id="footer" className="bg-[#0f1117]">
      ...
      {/* ── Logo + tagline ── */}
      <div className="px-4 min-[375px]:px-5 pt-7 pb-5 border-b border-white/10 flex items-center gap-3 min-[375px]:gap-4">
        <img
          src={footerImg}
          alt="Grohair"
          className="w-[130px] min-[375px]:w-[150px] min-[425px]:w-[160px] sm:w-[200px] h-auto object-contain shrink-0"
        />
        <p className="text-[11px] min-[375px]:text-[12px] min-[425px]:text-[14px] text-white/35 leading-snug font-semibold whitespace-nowrap">Advanced Grohair &amp; Gloskin<br />Cumbum</p>
      </div>
      ...
      <div className="px-5 py-5 border-b border-white/10 flex flex-col gap-4">
        ...
        {/* Phone → Dialer */}
        <a href="tel:+919962556789" className="flex items-center gap-3 group">
          ...
          <span className="text-[12px] text-white/45 hover:text-red-400 active:text-red-400 transition-colors">99625 56789</span>
        </a>

        {/* Email → Mail app */}
        <a href="mailto:adgrohaircbm@gmail.com" className="flex items-center gap-3 group">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="w-4 h-4 text-red-500 shrink-0">
            <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/>
            <polyline points="22,6 12,13 2,6"/>
          </svg>
          <span className="text-[12px] text-white/45 hover:text-red-400 active:text-red-400 transition-colors">adgrohaircbm@gmail.com</span>
        </a>
