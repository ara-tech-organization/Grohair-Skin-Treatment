...
import { PHONE_HREF } from '../constants/siteDetails'
  ...
  return (
    <header className="flex items-center justify-between px-4 py-0.5 bg-white border-b border-gray-200 sticky top-0 z-50">
      ...
      <img
        src={logoImg}
        alt="Grohair"
        className="h-[26px] min-[360px]:h-[30px] min-[390px]:h-[34px] min-[425px]:h-[38px] sm:h-[55px] w-auto min-w-[60px] object-contain"
      />
