...
const MAPS_URL = 'https://www.google.com/maps/search/?api=1&query=1056+C+Third+Floor+UR+House+Avinashi+Rd+near+Anna+Silai+Coimbatore+Tamil+Nadu+641018'
  ...
  return (
    <footer id="footer" className="bg-[#0f1117]">
      ...
      <div className="px-5 pt-7 pb-5 border-b border-white/10 flex items-center gap-6">
        <img src={logoImg} alt="Gloskin" className="h-20 w-auto object-contain" />
        <p className="text-[14px] text-white/35 leading-relaxed font-semibold">Advanced Gloskin<br />Avinashi Road Coimbatore</p>
      </div>
      ...
      <div className="px-5 py-5 border-b border-white/10 flex flex-col gap-4">
        ...
        >
          ...
          <span className="text-[12px] text-white/45 leading-relaxed hover:text-red-400 active:text-red-400 transition-colors">
            1056 C, Third Floor, UR House, Avinashi Rd, near Anna Silai, Coimbatore, Tamil Nadu 641018
          </span>
        </a>

        {/* Phone → Dialer */}
        <a href="tel:+918270356789" className="flex items-center gap-3 group">
          ...
          <span className="text-[12px] text-white/45 hover:text-red-400 active:text-red-400 transition-colors">82703 56789</span>
        </a>

        {/* Email → Mail app */}
        <a href="mailto:avinashiroadcmbtr@adgrohair.com" className="flex items-center gap-3 group">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="w-4 h-4 text-red-500 shrink-0">
            <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/>
            <polyline points="22,6 12,13 2,6"/>
          </svg>
          <span className="text-[12px] text-white/45 hover:text-red-400 active:text-red-400 transition-colors">avinashiroadcmbtr@adgrohair.com</span>
        </a>
